    ...
    if(isset($_POST["exportarCSV"])) {
        ...
        if(($red_1 != 'TODOS') and $dist_1 == 'TODOS'){
            $resultado = "SELECT a.Provincia_Establecimiento, a.distrito_establecimiento, a.Abrev_Tipo_Doc_Paciente, a.Nombre_Establecimiento,a.Numero_Documento_Paciente, A.Fecha_Nacimiento_Paciente,t.Edad_Reg,
                            ...
                            from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA_DETALLADO a  left join
                            ...
                            from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA_DETALLADO t
                            where  t.anio='2021' and t.mes='$mes' AND  ((t.Codigo_Item='96150' and t.Valor_Lab='VIF' AND t.Tipo_Diagnostico='D') OR
                                ...
                                t.Id_Cita IN
                                  (select t.Id_Cita from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA_DETALLADO t
                            ...
                            where  a.anio='2021' AND a.MES='$mes' AND a.Provincia_Establecimiento='$red_1' and a.Codigo_Item='99208' and a.Tipo_Diagnostico='D' and a.Id_Ups='301612' and a.Id_Condicion_Establecimiento in ('N','R')
            ...
            $dist = '';
            $resultado = "SELECT a.Provincia_Establecimiento, a.distrito_establecimiento, a.Abrev_Tipo_Doc_Paciente, a.Nombre_Establecimiento,a.Numero_Documento_Paciente, A.Fecha_Nacimiento_Paciente,t.Edad_Reg,
                              a.Fecha_Atencion, t.Codigo_Item from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA_DETALLADO a  left join
                              (select t.Provincia_Establecimiento,t.Distrito_Establecimiento,t.Nombre_Establecimiento,t.Descripcion_Ups, t.Numero_Documento_Paciente,
                                      t.Tipo_Diagnostico,t.Codigo_Item, t.Valor_Lab, t.Edad_Reg,t.Fecha_Atencion
                              from T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA_DETALLADO t
                              where  t.anio='2021' and t.mes='$mes' and ((t.Codigo_Item='96150' and t.Valor_Lab='VIF' AND t.Tipo_Diagnostico='D') OR
            ...
            $resultado = "SELECT a.Provincia_Establecimiento, a.distrito_establecimiento, a.Abrev_Tipo_Doc_Paciente, a.Nombre_Establecimiento,a.Numero_Documento_Paciente, A.Fecha_Nacimiento_Paciente,t.Edad_Reg,
                            ...
                            where  t.anio='2021' and t.mes='$mes' AND  ((t.Codigo_Item='96150' and t.Valor_Lab='VIF' AND t.Tipo_Diagnostico='D') OR
                                ...
                                t.Id_Cita IN
                                  ...
                                  AND t.Edad_Reg>17 AND t.Tipo_Edad='A')   ) t
                            on a.Numero_Documento_Paciente=t.Numero_Documento_Paciente
                            where  a.anio='2021' AND a.MES='$mes' AND a.Provincia_Establecimiento='$red_1' AND a.distrito_establecimiento='$dist' and a.Codigo_Item='99208' and a.Tipo_Diagnostico='D' and a.Id_Ups='301612' and a.Id_Condicion_Establecimiento in ('N','R')
                            AND (a.Edad_Reg>17 AND a.Tipo_Edad='A') and (a.Codigo_Unico NOT IN ('000000979','000000980','000000981'))";
        }
